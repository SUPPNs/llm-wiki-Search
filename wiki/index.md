...
2. [[questions/integrating-behavior-and-knowledge-graphs|行動二部グラフと知識グラフをどのように統合するか]] で、統合研究の未解決点を確認する。
3. [[themes/hybrid-graph-rag-for-grounded-recommendations|根拠付き推薦のためのハイブリッド Graph-RAG]] で、検証可能な研究方法へ落とし込む。
...
- [[concepts/graphrag|GraphRAG]] - 知識グラフを用いた RAG の設計空間と、BGR との境界を整理する。
